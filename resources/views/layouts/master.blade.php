...
<head>
    ...
    <link rel='icon' href='img/mini.jpg' type='image/x-icon'/ >
    ...
    <div class="header_btm">
        ...
        <div class="menu">
            <ul>
                ...
                <li><a href="{{asset('bakery')}}">Bakery</a></li>
                <li><a href="{{asset('sweets')}}">Sweets</a></li>
                <li> <a href="{{asset('gift')}}" title=""> Gift</a></li>
